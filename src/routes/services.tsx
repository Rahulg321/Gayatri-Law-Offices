...
export const Route = createFileRoute('/services')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Comprehensive legal process outsourcing services: contract drafting, document review, legal research, litigation support, due diligence, IP, and paralegal services.' },
    ],
  }),
  ...
  return (
    <main className="page-wrap px-4 pb-16 pt-28 sm:pt-32">
      <section className="text-center">
        <Badge variant="outline" className="mb-4 rounded-full border-[var(--gold)]/30 px-3 py-1 text-[10px] tracking-[0.2em] text-[var(--gold)] uppercase">What We Offer</Badge>
        <h1 className="display-title mb-4 text-4xl leading-[1.06] font-semibold tracking-tight text-[var(--charcoal)] sm:text-5xl">Comprehensive LPO Services</h1>
        <p className="mx-auto max-w-2xl text-base leading-relaxed text-[var(--charcoal-soft)] sm:text-lg">
          From contract drafting to litigation support, our services are designed to help law firms reduce costs, scale efficiently, and deliver exceptional results.
        </p>
      </section>
