    ...
    <main className="page-wrap px-4 pb-16 pt-28 sm:pt-32">
      <section className="text-center">
        ...
        <p className="mx-auto max-w-2xl text-base leading-relaxed text-[var(--charcoal-soft)] sm:text-lg">
          A sample of past work spanning document review, remote paralegal programs, litigation support, legal research, and
          corporate diligence — each delivered with the same confidentiality standards we apply to every client.
        </p>
      </section>
      ...
      <section className="mt-12 grid gap-6 sm:mt-16 sm:grid-cols-2">
        {portfolioProjects.map((project, i) => (
          <Link key={project.slug} to="/projects/$slug" params={{ slug: project.slug }} className="group no-underline">
            <Card
              className="feature-card rise-in h-full border-[var(--line)] transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-1 hover:border-[var(--gold)]/30"
