...
import { adminBlogFormSchema } from "#/features/blogs/schemas";
import { estimateReadTime } from "#/features/blogs/helpers";
import { adminDeleteBlogPost } from "#/features/blogs/server/mutations/delete-blog-post";
import { adminSaveBlogPost } from "#/features/blogs/server/mutations/save-blog-post";
...
export function AdminBlogEditPage({
  ...
  return (
    <div>
      <BlogEditForm key={slug} initial={initial} isNew={slug === "new"} />
    </div>
  );
}
